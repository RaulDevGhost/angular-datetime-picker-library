...
export const MAT_DATEPICKER_TIME_CONTROL_NAME = new InjectionToken<string>(
  'custom form control name for datepicker header input'
);

export function _handleUserSelection<D, S>(
  this: any,
